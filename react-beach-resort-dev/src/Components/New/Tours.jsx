...
import tour1 from "../../assets/new/tour1.png";
import tour2 from "../../assets/new/tour2.png";
import tour3 from "../../assets/new/tour3.png";
import vector1 from "../../assets/new/vector1.png";
import vector2 from "../../assets/new/vector2.png";
import ellipse from "../../assets/new/ellipse.png";

export default function Tours() {
  const redirectToTour = () => {
    window.location.href = 'http://localhost:3001/tour';
  };
  const data = [
    {
      image: tour1,
